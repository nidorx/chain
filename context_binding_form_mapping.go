...
// see: https://github.com/gin-gonic/gin/blob/master/binding/multipart_form_mapping.go
package chain
...
func setWithProperType(val string, value reflect.Value, field reflect.StructField) error {
	...
	case reflect.Struct:
		...
		return json.Unmarshal(unsafe.Slice(unsafe.StringData(val), len(val)), value.Addr().Interface())
	case reflect.Map:
		return json.Unmarshal(unsafe.Slice(unsafe.StringData(val), len(val)), value.Addr().Interface())
	case reflect.Ptr:
